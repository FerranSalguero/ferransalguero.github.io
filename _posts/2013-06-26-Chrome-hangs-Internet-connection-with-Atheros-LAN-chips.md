...
description: "Fix for Chrome hanging your internet connection on Windows 7/8 with Atheros L1 Gigabit Ethernet adapters: disable task offloading in Device Manager."
lastmod: 2015-07-14
---

From time to time I found that Chrome hangs my internet connection on typical tasks like uploading an image, I had resolved this problem a few years ago and suddenly I found the same problem after installing Windows 8.
